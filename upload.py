...
from job_list import list_jobs  # Import list_jobs from job_list.py
        ...
        if supabase:
            try:
                ...
                if hasattr(response, 'data') and response.data:
                    ...
                    st.session_state['redirect_to'] = 'job_list'  # Set a session state variable to indicate redirection
                    st.rerun()
                else:
